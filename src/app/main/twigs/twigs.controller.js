(function () {
    ...
    /** @ngInject */
    function ItemsController($state, $mdDialog, $mdSidenav, msUtils, $filter, $scope, msApi, $q, $rootScope, AuthenticationService) {
        var vm = this;
        ...
        this.callServer = function callServer(tableState) {
            ...
            var params = { limit: number, page: currentPage, latitude: 0, longitude: 0 }
            if ($scope.role != 'ADMIN') {
                params['business_id'] = AuthenticationService.getSelectedBusiness().id
                alert(params['business_id'])
            }
            msApi.request('twigs.twigs@get', params,
                function (res) {
                    //console.log(res);
