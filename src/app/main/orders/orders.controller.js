(function () {
    ...
    /** @ngInject */
    function OrdersController($state, $mdDialog, msApi, $scope, $filter, msUtils, Upload, $rootScope, $http, $mdSidenav, $q, AuthenticationService) {
        var vm = this;
