        ...
        function login() {
            ...
            msApi.request('login@save', {
                ...
                function (response) {
                    ...
                    if (response.data.roles[0]['id'] == 2 && AuthenticationService.getSelectedBusiness() == null) {
                        var params = { user_id: $scope.userId }
                        msApi.request('businesses.businesses@get', params,
                            function (res) {
                                console.log(res);
                                AuthenticationService.setSelectedBusiness(res.data[0])
