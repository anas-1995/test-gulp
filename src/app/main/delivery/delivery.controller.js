(function () {
    ...
    angular
        .module('app.delivery')
        .controller('DeliveryZonesController', function ($state, $mdDialog, msApi, $scope, $filter, msUtils, $rootScope, AuthenticationService) {
            var vm = this;
            $scope.searchKeyword = "";
            ...
            $scope.callServer = function (tableState) {
                ...
                msApi.request('delivery_zones.delivery_zones@get', params,
                    function (res) {
                        console.log(res);
                        $scope.total_pages = res.paginator.total_count;
                        tableState.pagination.numberOfPages = res.paginator.total_pages;
