(function()
{
    ...
    /** @ngInject */
    function BrandsController($state, $mdDialog, msApi,$filter, $scope)
    {
        var vm = this;
        ...
        this.callServer = function callServer(tableState) {
            ...
            msApi.request('brands.brands@get', {limit: number, page: currentPage,'all':'yes'},
            function(res) {
                console.log(res);              
...
//        };
        ...
        {
           // console.log("item ", item);
            $state.go('app.brands.brands-view', {id: item.id});
        }
